	...
	init: {
		...
		FileUploaded: function(up, file, info) {
	        if (info.status == 200){
	            ...
	            document.getElementById('headPicName').value = object_name;
	            var src = document.getElementById('pathPic').value + object_name;
	            document.getElementById("headPicNameImg").src=src;
