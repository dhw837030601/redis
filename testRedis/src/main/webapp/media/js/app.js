//正式
var noteAddress = "http://www.wallet.com/";//前台首页路径
var courseVideoBucket = "course/";
var noteVideoBucket = "short-video/";
var coursePicBucket = "";

//测试
//var noteAddress = "http://192.168.0.210:8081/"//前台首页路径
//var courseVideoBucket = "course_test/";
//var noteVideoBucket = "short_video_test/";
//var coursePicBucket = "test/";
var App = function () {
	...
	var refreshDirectory = function (){
		...
		$.ajax({
			...
			url : '/authority/refreshdirectory',
	...
	var modifyPwd = function (){
		...
		$.ajax({
			...
			data : 'staffId='+staffId+'&oldPwd='+oldPwd+'&newPwd='+newPwd,
    ...
    return {
        ...
        init: function () {
            ...
            $('#refreshAction').click(function(){
        		...
        		$('#refreshActionPrompt').modal('show');
        		
        	});
        	
        	// 更新action时确定按钮
        	$('#doRefreshAction').click(function(){
        		
                $('#refreshActionPrompt').modal('hide');
        	...
        	// 更新菜单
        	$('#refreshDirectory').click(function(){
				
				$('#refreshDirectoryPrompt').modal('show');
				
			});
			
			// 更新菜单时确定按钮
			$('#doRefreshDirectory').click(function(){
				
                $('#refreshDirectoryPrompt').modal('hide');
            ...
            $('#modifyPwd').click(function(){
        		...
        		$('#modifyPwdPrompt').modal('show');
        		
        	});
            
            // 确认修改密码
            $('#doSavePwd').click(function(){
